package id.ac.poliban.dts.mirhan.sqlitetesting;
...
import id.ac.poliban.dts.mirhan.sqlitetesting.dao.impl.FriendDaoImplSQLite;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btUpdate.setOnClickListener(v -> {
            ...
            db.delete(id);
            Toast.makeText(this, "delete succes!, check in run monitor!", Toast.LENGTH_SHORT).show();
        });

        btGetAFriend.setOnClickListener(v -> {
            int id = Integer.parseInt(etId.getText().toString());
            Friend f = db.getAFriendById(id);
            Toast.makeText(this, "get a friend succes!, check in run monitor", Toast.LENGTH_SHORT).show();
